CREATE TABLE "autopilot_scan_events" (
	...
	CONSTRAINT "autopilot_scan_events_terminal_check" CHECK (("autopilot_scan_events"."status" = 'dispatched' AND "autopilot_scan_events"."decision" = 'dispatched' AND "autopilot_scan_events"."run_id" IS NOT NULL) OR ("autopilot_scan_events"."status" = 'failed' AND "autopilot_scan_events"."decision" = 'worker_failed' AND "autopilot_scan_events"."run_id" IS NULL) OR ("autopilot_scan_events"."status" = 'skipped' AND "autopilot_scan_events"."decision" NOT IN ('dispatched', 'worker_failed') AND "autopilot_scan_events"."run_id" IS NULL))
);
