...
const ERROR_MESSAGE_KEYS: Record<ErrorCode, string> = {
  ...
  telegram_login_cooldown: "telegram_login_cooldown",
  telegram_login_expired: "telegram_login_expired",
  telegram_login_invalid: "telegram_login_invalid",
  ...
  recheck_preview_stale: "recheck_preview_stale",
  ...
  claim_review_not_editable: "claim_review_not_editable",
  claim_review_no_search_key: "claim_review_no_search_key",
  claim_review_no_ai_key: "claim_review_no_ai_key",
  claim_correction_stale: "claim_correction_stale",
  claim_correction_not_found: "claim_correction_not_found",
  claim_correction_ineligible: "claim_correction_ineligible",
  claim_correction_no_credential: "claim_correction_no_credential",
  claim_correction_limit_reached: "claim_correction_limit_reached",
  claim_correction_failed: "claim_correction_failed",
  claim_correction_timed_out: "claim_correction_timed_out",
  content_images_changed: "content_images_changed",
  content_image_crop_invalid: "content_image_crop_invalid",
  content_images_need_review: "content_images_need_review",
  content_media_pinned: "content_media_pinned",
  ...
  content_topic_veto_has_delivery_history: "content_topic_veto_has_delivery_history",
  ...
  content_delete_not_draft: "content_delete_not_draft",
  ...
  approval_retraction_not_approved: "approval_retraction_not_approved",
  ...
  schedule_too_close: "schedule_too_close",
  schedule_changed: "schedule_changed",
  schedule_not_scheduled: "schedule_not_scheduled",
  schedule_parent_not_ready: "schedule_parent_not_ready",
  schedule_has_history: "schedule_has_history",
  ...
  readapt_failed: "readapt_failed",
  readapt_proposal_not_found: "readapt_proposal_not_found",
  readapt_source_changed: "readapt_source_changed",
  ...
  refine_proposal_not_found: "refine_proposal_not_found",
  refine_would_launder: "refine_would_launder",
