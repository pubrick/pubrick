...
export class MediaRepository {
  ...
  /** Cheap preflight before a billed cover call; the attach repeats every gate. */
  async coverForRegeneration(orgId: string, itemId: string, expectedCoverMediaId: string | null) {
  ...
  async attach(
    ...
    itemId: string,
    mediaId: string | null,
    expectedCoverMediaId?: string | null,
  ) {
    return db.transaction(async (tx) => {
