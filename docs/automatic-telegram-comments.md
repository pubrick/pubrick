...
Collection reads Telegram only. It does not call Gemini or perform paid comment analysis. Analysis remains a separate manual action with its own admission and cost controls.
