...
| Autopilot | Owner-controlled scheduled draft generation from approved topics, with per-brand quota and spend admission threshold | Optional daily topic suggestion and calendar planning, richer review signals |
