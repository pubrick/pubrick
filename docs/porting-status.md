...
| Channels | Telegram, VK, MAX and Bluesky delivery; VC.ru manual publication workflow | Other platform adapters and channel-specific publishing options |
...
| Multi-agent generation | Five-step engine, run receipts, current UTC date in every model step, public article URL preview, selected social post/news digest/product update/expert article/how-to/source retelling formats, and opt-in homepage UTM tagging | Case study/comparison formats, video/newsletter repurposing and deeper SEO workflow |
...
| Publishing | Telegram, VK, MAX and Bluesky delivery with retry and outcome reconciliation; VC.ru copy and self-reported URL; opt-in public RSS syndication | Native delivery for other platforms and verified Dzen ingestion support |
