...
| Analytics | Usage and cost ledger; brand results, on-demand VK post metrics and opt-in background VK collection; on-demand bounded reply samples for owned Telegram publications | AI synthesis of publication replies, other-channel metrics and performance feedback |
