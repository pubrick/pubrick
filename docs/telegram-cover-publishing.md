...
The reviewed item and channel text stay frozen until this partial delivery is
resolved, so the draft still describes the live photo and its missing reply.
